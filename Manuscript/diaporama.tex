...
\section*{}
{
\setbeamercolor{background canvas}{bg=SolarizedBrWhite}
\begin{frame}[plain, c]
    \vfill
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[height=\textheight]{Ressources/Images/methode.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[height=\textheight]{Ressources/Images/Demonstration/repartition_capteur.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[width=\textwidth]{Ressources/Images/Optimisation/LevyFlight/levy_length.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[width=1.2\textwidth, clip=true, trim=45mm 0mm 0mm 0mm]{Ressources/Templates/Optimisation/Validation/dtlz1.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[width=1.25\textwidth, clip=true, trim=60mm 0mm 0mm 0mm]{Ressources/Templates/Optimisation/Validation/dtlz7.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[height=\textheight]{Ressources/Images/Sensibilite/sigma_mu_star_1.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[height=\textheight]{Ressources/Images/Sensibilite/sigma_mu_1.pdf}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \includegraphics[height=0.5\textheight]{Ressources/Images/EtudeDeCas/Strasbourg_algo.pdf}
    \includegraphics[height=0.5\textheight]{Ressources/Images/EtudeDeCas/Bordeaux_algo.pdf}
    \vfill
\end{frame}
...
% ------------------------------------------------------------------------------
\subsection{Résultats d’optimisation~: Strasbourg}

\begin{frame}[noframenumbering, c]
    \vfill
    \centering
    \begin{adjustwidth}{-2.2em}{-2.2em}
    \includegraphics[width=1.1\textwidth]{Ressources/Images/EtudeDeCas/evolution_perf_nb_capteurs.pdf}
    \end{adjustwidth}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    ...
    \centering
    \begin{adjustwidth}{-2.2em}{-2.2em}
    \includegraphics[width=1.1\textwidth]{Ressources/Images/EtudeDeCas/Strasbourg_front_enveloppe_colormap.pdf}
    \end{adjustwidth}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    ...
    \centering
    \begin{adjustwidth}{-2.2em}{-2.2em}
    \includegraphics[width=1.1\textwidth]{Ressources/Images/EtudeDeCas/Strasbourg_front.pdf}
    \end{adjustwidth}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    ...
    \centering
    \begin{adjustwidth}{-2.2em}{-2.2em}
        \includegraphics[width=1.1\textwidth]{Ressources/Images/EtudeDeCas/strasbourg_smalltanks_variations.pdf}
    \end{adjustwidth}
    \vfill
\end{frame}
...
\begin{frame}[noframenumbering, c]
    ...
    \centering
    \begin{adjustwidth}{-2.2em}{-2.2em}
        \includegraphics[width=1.1\textwidth]{Ressources/Images/EtudeDeCas/Bordeaux_front.pdf}
    \end{adjustwidth}
    \vfill
\end{frame}
