...
\begin{frame}[t]
    ...
    \begin{adjustwidth}{-2.4em}{-2.4em}
        \includegraphics[width=1.2\textwidth]{Ressources/Images/EtudeDeCas/Strasbourg_front_nb_capteurs.pdf}
    \end{adjustwidth}
\end{frame}
...
\begin{frame}[t]
    ...
    % \vskip1em
    \begin{adjustwidth}{-2.4em}{-2.4em}
        \includegraphics[width=1.17\textwidth]{Ressources/Images/Soutenance/Resultats/impact_ballon.pdf}
    \end{adjustwidth}
