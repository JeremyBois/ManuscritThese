...
\begin{frame}[c]
    ...
    \only<2>{\includegraphics[width=0.95\textwidth]{Ressources/Images/Soutenance/Problematique/modele_generique_besoinsCH.pdf}}
    \only<3>{\includegraphics[width=0.95\textwidth]{Ressources/Images/Soutenance/Problematique/modele_generique_ECS.pdf}}
    \only<4>{\includegraphics[width=0.95\textwidth]{Ressources/Images/Soutenance/Problematique/modele_generique_CH.pdf}}
    \only<5>{\includegraphics[width=0.95\textwidth]{Ressources/Images/Soutenance/Problematique/modele_generique_Elec.pdf}}
    \vfill
\end{frame}
...
\begin{frame}[t]
    ...
    \small
    \begin{itemize}
        \item<1->[--] Multi-critères.
        \item<2->[--] Indicateur de performance ?
        \item<3->[--] Performance SSC + MEPOS ?
        \item<4->[--] Équilibre Besoins / Capacité de production / Consommations ?
    \end{itemize}
    \vfill
...
\begin{frame}[t]
    \addalert{Poser la question de la nécessité de toutes les variables génériques}
    \vfill
\end{frame}
...
\begin{frame}[c]
    \vfill
    \centering
    \includegraphics[width=0.95\textwidth]{Ressources/Images/Soutenance/Application/air_complet_mono_PV.pdf}
    \vfill
\end{frame}
