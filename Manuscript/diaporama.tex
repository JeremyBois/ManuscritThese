        ...
        \begin{column}{0.9\textwidth}
            \begin{center}
                \begin{itemize}
                    ...
                    \item[--] Potentiel SSC + MEPOS ?
                    \item[--] Indicateur de performance ?
                    \item[--] Équilibre Besoins / Capacité de production / Consommations ?
                \end{itemize}
                \vskip2em
                \uncover<2->{%
                \begin{itemize}
                    ...
                    \item[--] Dimensionnement couplé enveloppe / SSC.
