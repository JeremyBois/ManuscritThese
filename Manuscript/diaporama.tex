...
\begin{frame}[t]
    ...
    \begin{adjustwidth}{-2em}{-2em}
        ...
        \begin{itemize}
            ...
            \vskip1em
            \item<2-> Quelle adéquation entre besoins / production / consommations ?
        \end{itemize}
        ...
        \begin{itemize}
            \small
            \item<3-> Problématique multi-critères et multi-physiques. \\
            \vskip1em
            \item<3-> Partager la surface disponible en toiture.
        \end{itemize}
        \vfill
    \end{adjustwidth}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \vskip0.5em
            \item[--] afin de converger vers un ensemble de solutions pertinentes.
        \end{itemize}
        \vfill
...
\begin{frame}[c]
    ...
    \begin{tabular}{l c c c c c c c c}
        ...
        \\
        \addlinespace[\defaultaddspace]
        \uncover<3->{Appoint (\si{\percent})  & $F_{sav,\,ext}$ & &  \num{57} & \alt<3>{\cellcolor{SolarizedGreen}}{}\num{90} & & & \num{42}   & \alt<4>{\cellcolor{SolarizedGreen}}{}\num{72}} \\
        \\
        \addlinespace[\defaultaddspace]
        \uncover<4->{Appoint (\si{kWh}) & ECS + CH & &  \num{324} & \num{1372} & & & \num{1222}   & \num{3117}} \\
        \bottomrule
    \end{tabular}
    \end{table}
    \vfill
