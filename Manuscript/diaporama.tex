...
\begin{frame}[c]
    \vfill
    \centering
    \includegraphics[height=0.4\textheight]{Ressources/Images/Soutenance/Contexte_objectifs/evolution_effet_serre_cleaned.png}
    \vfill
    \uncover<2->{
    \includegraphics[height=0.4\textheight]{Ressources/Images/Soutenance/Contexte_objectifs/elevation_temperature_global.png}
    }
    \vfill
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.9\textwidth}
            \begin{center}
                \begin{itemize}
                    \footnotesize
                    \item[--] Multi-physiques et multi-critères.
                    \item[--] Quel potentiel ?
                    \item[--] Quels indicateurs ?
                    \item[--] Équilibre enveloppe / efficacité des systèmes ?
                \end{itemize}
                \vskip1.5em
                \uncover<2->{%
                \begin{itemize}
                    ...
                    \item[--] Dimensionnement couplé enveloppe / SSC / logique de contrôle.
...
\begin{frame}[c]
    \vfill
%     \only<1>{\includegraphics[width=0.95\textwidth]{Ressources/Images/Modelisation/Principe/air_complet_mono.pdf}}
...
\begin{frame}[c]
    ...
    \begin{itemize}
        \item Occupation fixe
        \item Consigne de chauffage~: 16-18-19
        \item Équipements et éclairage~: scénarios $RT\,2012$
    \end{itemize}
    Profil de Puisage (couper image)
    % \includegraphics[height=0.5\textheight]{Ressources/Images/Modelisation/Scenario/puisage.pdf}
    \vfill
\end{frame}
...
%     \only<5>{\includegraphics[height=0.95\textheight]{Ressources/Images/Soutenance/Methodologie/comportement_abeilles_steps_5.pdf}}
%     \vfill
...
%         \begin{column}{0.4\textwidth}
%         \centering
%         \colorbox{SolarizedBrWhite}{1}Définition des bornes\\
%         \includegraphics[height=0.35\textheight]{Ressources/Images/Soutenance/Methodologie/morris_definition.pdf}
%         \vskip1.5em
%             \uncover<3->{%
%             \colorbox{SolarizedBrWhite}{3} Évaluation de l’influence\\
...
%             \centering
%             \uncover<2->{%
%             \colorbox{SolarizedBrWhite}{2} Création d’un plan d’expérience\\
...
%         \begin{column}{0.6\textwidth}
%             \centering
%             \colorbox{SolarizedBrWhite}{1} Définition d’un échantillon représentatif
%             \includegraphics[width=0.8\textwidth]{Ressources/Images/MetaModele/halton_vs_uniform.pdf}
%         \end{column}
%         \begin{column}{0.4\textwidth}
%             \centering
%             \colorbox{SolarizedBrWhite}{2} Minimisation de l’erreur quadratique moyenne
%             \includegraphics[width=0.3\textwidth]{Ressources/Images/Logos/openturns.png}
%         \end{column}
%     \end{columns}
%     }
...
\begin{frame}[c]
    ...
    \begin{table}
    \centering
    Variation de performance pour les solutions optimales (\si{kWh})
    \vskip1.5em
    \begin{tabular}{l c c c c c c c}
        \toprule
                        ...
                        & & min & max   &       & & min & max \\
        \midrule
        $Conso_{ref}^{ECS}$  & & \multicolumn{2}{c}{2588}  & &  & \multicolumn{2}{c}{2866}  \\
        \addlinespace[\defaultaddspace]
        $Conso_{ref}^{CH}$  & & \num{228}  & \num{620} & &  & \num{1363}   & \num{2110} \\
        \addlinespace[\defaultaddspace]
        $Conso_{app}^{ECS}$ & & \num{156} & \num{1043} & & & \num{397}   & \num{1360} \\
