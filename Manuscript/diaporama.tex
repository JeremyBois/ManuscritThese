...
% ------------------------------------------------------------------------------
\subsection{Interrogations / Contraintes}
\begin{frame}[t]
    ...
    \begin{adjustwidth}{-2em}{-2em}
        ...
        \begin{itemize}
            \small
            \item Quelle performance SSC + MEPOS ?
            \vskip1em
            \item Quelle adéquation entre besoins / production / consommations ?
        \end{itemize}
        ...
        \begin{column}{0.8\textwidth}
            ...
            \uncover<6->{%
                \begin{itemize}
                    ...
                    \item<7-> \footnotesize $\abs{Prod_{PV} - Conso_{usages} - Conso_{app}}  \geq  8 \si{kWh_{ep}\per\metre\squared}$
                \end{itemize}
            }
        \end{column}
    \end{columns}
