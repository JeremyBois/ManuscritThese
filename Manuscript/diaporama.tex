...
\setbeamercolor{middle separation line head}{bg=black!8, fg=SolarizedBrBlack}
...
{%
    ...
    \begin{beamercolorbox}[colsep=1.5pt, sep=0.2em]{middle separation line head}
        \vskip3pt \textsc{\textbf{ \scriptsize \insertsubsectionhead}} \hfill
    \end{beamercolorbox}
...
\begin{frame}[c]
    \vfill
    \includegraphics[width=0.95\textwidth]{Ressources/Images/Soutenance/CasEtude/modes_base.pdf}
    \vfill
\end{frame}
