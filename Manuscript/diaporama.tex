...
\begin{frame}[c]
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            ...
            \vskip0.2em
            \begin{itemize}
                \item Position initiale
                \item Position opposée
            \end{itemize}
            \vskip2em
            }
            ...
            \begin{itemize}
                ...
                \item \alt<5->{\colorbox{SolarizedRed}{Vol de Lévy}}{Vol de Lévy}
            \end{itemize}
            \vskip2em
            }
...
\begin{frame}[c]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item[--] Algorithme d’optimisation nécessitant que deux paramètres.
        \end{itemize}
        \vfill
        \uncover<2->{%
        \item Application~:
        ...
        \vfill
        \item<3-> Potentiel des SSC pour des MEPOS en climats rudes.
        \item<4-> Potentiel des systèmes solaires pour toutes les MEPOS.
    \end{itemize}
    \vfill
\end{frame}
