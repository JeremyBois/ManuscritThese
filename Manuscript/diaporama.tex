...
\begin{frame}[t]
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[height=0.75\textheight, clip=true, trim=200mm 0mm 0mm 0mm]{Ressources/Images/EtudeDeCas/irradiations_climats.pdf}
        \end{column}
    \end{columns}
    \vfill
...
\begin{frame}[c]
    ...
    \vfill
    \centering
    \includegraphics[width=1.05\textwidth]{Ressources/Images/EtudeDeCas/strasbourg_tanks_variations_cum.pdf}
    \vfill
\end{frame}
