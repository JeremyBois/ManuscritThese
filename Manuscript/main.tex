...
% \usepackage{titletoc}
% \dottedcontents{figure}{\bfseries}{3em}{1pc}
% \dottedcontents{table}{\bfseries}{3em}{1pc}
...
% Chapters
% ------------------------------------------------------------------------------
\itodo{Ajouter introduction}
\itodo{Ajouter résumé par chapitre}
\itodo{Ajouter Conclusion}

% \chapter*{Introduction}
% \input{Chapitres/Introduction}

\chapter{Le solaire thermique appliqué au bâtiment, un problème multi-critères}
