...
% ------------------------------------------------------------------------------
% Support for PDF/A standard (see file main.)
% ------------------------------------------------------------------------------
...
\hypersetup{
    pdfkeywords={Système solaire combiné,
    ...
    pdfsubject={},                         % abstract of the document
...
\itodo{irradiation = puissance --> modifie partout}
\itodo{Ajouter diagramme de sankey}
\itodo{Ajouter équation de mélange pour eau froide}
