...
% volume_collector_factorplot
    \centering
    \includegraphics{Ressources/Images/EtudeDeCas/bordeaux_tanks_variations.pdf}
...
% volume_collector_factorplot
    \centering
    \includegraphics{Ressources/Images/EtudeDeCas/strasbourg_tanks_variations_cum.pdf}
    \caption[Réparitition des solutions en fonction des sous-groupes de taille de
...
% volume_collector_factorplot
    \centering
    \includegraphics{Ressources/Images/EtudeDeCas/strasbourg_smalltanks_variations.pdf}
