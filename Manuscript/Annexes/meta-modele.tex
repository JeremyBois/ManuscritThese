...
\begin{figure}
    \centering
    \includegraphics[height=0.32\textheight]{Ressources/Images/MetaModele/RMSE_ref.pdf}
    \includegraphics[height=0.32\textheight]{Ressources/Images/MetaModele/MAE_ref.pdf}
    \includegraphics[height=0.32\textheight]{Ressources/Images/MetaModele/validite_meta_ref_400.pdf}
