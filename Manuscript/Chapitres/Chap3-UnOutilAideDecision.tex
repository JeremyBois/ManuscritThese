...
$j$. Ainsi la précision de l’analyse est fonction du nombre de trajectoires définies à
...
% ------------------------------------------------------------------------------
\subsection{Réduction du modèle} % (fold)
\label{sub:reduction_du_modele}
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Définition et principe des méta-modèles} % (fold)
\label{ssub:definition_et_principe_des_meta_modeles}
~
\itodo{Voir thèse Rhania Mereb et Stéphanie}
% subsubsection definition_et_principe_des_meta_modeles (end)



% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Limites et avantages} % (fold)
\label{ssub:limites_et_avantages}
~
\itodo{Voir thèse Rhania Mereb et Stéphanie}
% subsubsection limites_et_avantages (end)
% subsection reduction_du_modele (end)
