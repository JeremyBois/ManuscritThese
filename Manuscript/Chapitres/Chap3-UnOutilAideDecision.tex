...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Ressources/Images/Optimisation/dominance.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Ressources/Images/Optimisation/convex.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{Ressources/Images/Optimisation/methodes_exactes.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Ressources/Images/Optimisation/a_star.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{Ressources/Images/Optimisation/meta_heuristique.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{Ressources/Images/Optimisation/ABC/comportement_abeilles.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Ressources/Images/Optimisation/ABC/abc_publication.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Ressources/Images/Optimisation/LevyFlight/distribution_pdf.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth, clip=True, trim=115mm 10mm 90mm 10mm]{Ressources/Images/Optimisation/LevyFlight/levy_vs_gaussian.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Ressources/Images/Optimisation/ABC/algorithme_complet.pdf}
...
\begin{itemize}
    ...
    \item Non-uniformité avec faible densité près de l’optimal~: \textit{ZDT6} et \textit{DTLZ5}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth, clip=True, trim=50mm 10mm 50mm 10mm]{Ressources/Templates/Optimisation/Validation/dtlz1.pdf}
        \caption{}
        \label{fig:dtlz1}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth, clip=True, trim=50mm 10mm 50mm 10mm]{Ressources/Templates/Optimisation/Validation/dtlz7.pdf}
        \caption{}
        \label{fig:dtlz7}
    \end{subfigure}
    \quad
