...
% ------------------------------------------------------------------------------
\subsection{Les méthodes d’optimisation multi-objectif} % (fold)
...
\paragraph{Heuristiques} % (fold)
\label{par:heuristics}
\itodo{Parallèles, heuristiques spécialisés, méta-heuristiques}

% paragraph heuristics (end)
% subsubsection description_des_approches_existantes (end)

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Sélection d’une méthode adapté au problème} % (fold)
\label{ssub:selection_d_une_methode_adapte_au_probleme}

% subsubsection selection_d_une_methode_adapte_au_probleme (end)
% subsection les_methodes_d_optimisation_multi_objectif (end)
