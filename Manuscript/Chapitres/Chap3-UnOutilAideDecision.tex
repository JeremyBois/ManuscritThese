...
\iunsure{Ajouter formulation utilisé pour la mise à jour ou juste pointer vers littérature}
...
\itodo{Ajouter limites et solutions proposées}
Au cours des années de nombreuses variation de la formulation de base ont été
proposées.
% paragraph extensions (end)
