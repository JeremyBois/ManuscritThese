...
d’aide à la décision a posteriori a été retenu. L’ensemble des solutions optimales offre
...
cas où une évaluation couplée du \abr{SSC} et du bâtiment est considérée. Afin de palier
à ces problèmes, des méthodes dites d’optimisation ont été développées. Dans un premier
...
l’inverse, l’algorithme \abr{PESA} tent à améliorer la convergence au prix
...
puis étendue aux aux problèmes multi-objectifs et combinatoires
...
\begin{figure}
    \centering
    \includegraphics[width=0.83\textwidth]{Ressources/Images/Optimisation/ABC/comportement_abeilles.pdf}
...
méta-modèles. Bien que nécessaire de ce cas précis, il reste préférable de conserver le
...
été retenue principalement car l’approche ne nécessite le paramétrage que de trois
...
classique, des solutions non faisables peuvent être retenue apportant ainsi de nouvelles
...
mise en place la méthodologie. Comme pour l’étude
...
L’optimisation est réalisée par une méta-heuristique et implémentée dans la bibliothèque \textit{pyMayBee}. Finalement l’aide à la
