...
\ftodo{Ajouter graphique décrivant les différents méthodes exactes avec les branches
       existantes des graphes précédents}
...
(\munsure{Ajouter citation}) qu’elles permettent de couvrir une grande partie du front
de Pareto.
