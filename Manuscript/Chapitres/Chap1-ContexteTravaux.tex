...
\itodo{Tendance}
L’$IEA$ actualise tout les ans son rapport sur l’évolution mondiale du solaire thermique
...
% ------------------------------------------------------------------------------
\subsection{Les avancées en thermique du bâtiment} % (fold)
\label{sub:les_avancees_en_thermique_du_batiment}
...
% subsection les_avancees_en_thermique_du_batiment (end)
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Pratiques actuelles du secteur} % (fold)
\label{ssub:pratiques_actuelles_du_secteur}
% subsubsection pratiques_actuelles_du_secteur (end)
...
\itodo{Réalisation en cascade : bâtiment puis choix d’un système}
\itodo{Course à la sur isolation renforcé par la réglementation}
\itodo{Contrôle en installation particulière peu détaillé}
\itodo{Évaluation du potentiel sans tenir compte du contrôle associé}
\itodo{Tenir compte des spécificités des climats}
\itodo{Trouver des compromis entre qualité de l’enveloppe et système}
\itodo{Compromis entre performance chauffage et ECS}
