...
\abr{SSC}s sont discutés. Ces avancées sont utilisées pour proposer un \abr{SSC} et une
...
appréhender la notion de \abr{BEPOS}, simple dans le contexte mais dont la mise en place
...
cadre européen (\abr{PREN\,$15603$}) est particulièrement important pour ces travaux car
...
les \abr{SSC} une solution potentielle.
...
de construction d’une \abr{MEPOS}. \abr{COMEPOS} est un projet français visant à traduire
le concept de \abr{BEPOS} pour la maison individuelle. Le projet regroupe à la fois des
...
les besoins et contraintes propre à la construction de futurs \abr{MEPOS} pour l’horizon
$2020$.
...
approche. Au niveau européen, une normalisation est ainsi en cours (\abr{PREN\,$15603$})
...
et par extension les \abr{SSC} apparaissent comme une solution pertinente pour répondre à
la fois au problème de réchauffement climatique et aider au respect des nouvelles
contraintes réglementaires. Bien que les \abr{SSC} soient en théorie une solution
pertinente, il reste cependant nécessaire d’évaluer le potentiel d’économie énergétique
qu’il peut apporter à travers l’évaluation d’un \abr{SSC} adaptée aux \abr{MEPOS}. C’est
dans cette optique qu’il est proposé à travers ces travaux une méthodologie pour aider à
la conception de \abr{MEPOS} solaire et permettre de caractériser leur potentiel.
...
Les \abr{SSC} restent donc une solution du futur mais leur dimensionnement doit être adaptée
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Ressources/Images/Solaire/compare_systems.png}
...
Des verrous et conclusions propre au sujet de ces travaux ont ainsi pu être identifiés~:
\begin{itemize}
...
mécaniques. Par extension la construction d’une \abr{MEPOS} solaire est donc aussi multi-objectifs.
...
La performance d’un \abr{SSC} innovant est ainsi caractérisé à la
