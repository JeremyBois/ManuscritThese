...
mais répondant toutes aux contraintes de la maison à énergie positive à travers une
...
Comme explicité ci-avant il est important de définir le contexte dans lequel s’inscrit
ces travaux. Cette section décrit dans un premiers temps les enjeux liés au réchauffement
climatique puis les différentes initiatives qui ont permis une prise de conscience
sur l’importance politique, économique, et environnemental d’un développement raisonné.
La dernière partie discute plus en détail les actions françaises et sa participation
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Ressources/Images/Environnement/evolution_effet_serre.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.7\textwidth]{Ressources/Images/Environnement/elevation_temperature.jpg}
...
énergétique en période hivernale. La difficulté réside ainsi à gérer les pointes
...
dans un projet de normalisation européenne pour le développement d’une définition
...
ou à proximité (\enquote{nearby}). Les travaux du \abr{CEN} ajoutent une description plus précise
