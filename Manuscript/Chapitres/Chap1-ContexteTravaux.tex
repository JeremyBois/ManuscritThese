...
à l’origine de la prise de conscience collective de l’impact destructeur lié à la
sur-utilisation des énergies fossiles. Ce sont en effet ces actions qui sont à l’origine des
...
sur le plan énergétique comme environnemental et la future réglementation imposera la
construction de \abr{BEPOS}s. La seconde partie de ce chapitre présente ainsi les
différents travaux et initiatives à l’origine de ce projet. Cette seconde partie met en
avant la complexité inhérente à la définition d’une base réglementaire internationale
commune pourtant nécessaire pour répondre de manière durable aux problématiques
énergétiques et environnementales. La troisième partie invite le lecteur à découvrir
l’histoire du développement des technologies solaires et les principales technologies
thermiques aujourd’hui utilisées. Finalement il y est décrit les différents travaux de la
littérature dans le domaine du solaire thermique et plus particulièrement pour les
\abr{SSC}. Ces avancées sont utilisées afin de pouvoir proposer un \abr{SSC} et une
méthodologie adaptée à la conception de \abr{MEPOS}s dont le détail de la démarche est
...
\begin{figure}
    ...
    % \includegraphics[width=\textwidth]{Ressources/Images/Environnement/hurdle_race.png}
...
\iunsure{Ajouter graphe montrant la répartition des applications}
...
de construire des \abr{BEPOS}. La contrainte de production renouvelable
locale par type d’énergie est ainsi une occasion de valoriser les \abr{SSC}.
% subsubsection bilan (end)
