...
politique nécessaire pour répondre aux enjeux climatiques et économiques. Le solaire lui
est une énergie quasi-infinie pouvant se substituer aux énergies finies telles que le
nucléaire ou les sources fossiles. Afin de proposer une méthodologie adaptée il est dans
un premier temps exposé le contexte climatique, l’importance du secteur du bâtiment, et
plus particulièrement la place de la maison individuelle. Suit une description de la
notion de maison à énergie positive et de la place du solaire thermique et plus
particulièrement des systèmes solaires combinés. Finalement en s’appuyant sur les travaux
existants et les contraintes propre au contexte, il est proposé une méthodologie d’aide à
la conception de maisons solaires à énergie positive appropriée.
\clearpage
...
% % ...........................................................................
% % ...........................................................................
\section{Objectifs et importance du contexte international} % (fold)
...
tels qu’ils bouleversent le fonctionnement de la planète. L’énergie (\defref{def:energie})
considérée comme infinie durant les \num{30} glorieuses s’est avérée être limitée et la
sur-utilisation des énergies fossiles comme nocive pour la faune et la flore de la
planète. Des mesures sont alors prises au niveau international et national afin de
contenir le réchauffement climatique et éviter un dérèglement plus important. Ces mesures
visent principalement à d’une part réduire la production de $C0_{2}$ mais d’autre part à
réduire les dépenses énergétiques. La population étant en augmentation, il est en effet
nécessaire de faire preuve de sobriété mais aussi de travailler au développement
d’énergies alternatives comme l’énergie solaire.

Le bâtiment est le premier consommateur d’énergie en France et est donc un élément clé
pour la réussite de la transition énergétique. Bien que la rénovation soit le principal
levier pour réduire les consommations du parc Français, son amélioration passe par le
développement des bâtiments neufs. Les nouveaux bâtiments doivent ainsi être innovants
énergétiquement afin de proposer des solutions économiquement viables et performantes pour
la rénovation. En effet l’amélioration de la conception des bâtiments neufs se traduit
dans le futur par une amélioration du parc immobilier. Avec $\nicefrac{3}{4}$ des
...
le potentiel d’un \abr{SSC} adapté aux \abr{BEPOS}s. Inspiré par la norme européenne
...
mais répondant toutes aux contraintes de la \abr{MEPOS} à travers une approche multi-objectifs.
...
textes réglementaires qui encadre la rénovation et la conception des bâtiments. Cette
...
\abr{BEPOS}s. La seconde partie de ce chapitre présente ainsi les différents travaux et
...
mesurée, récupérée, et les difficultés lié à l’évaluation d’un \abr{SSC} en particulier à
cause de géométrie diverses et variées. Il existe en effet de nombreuses technologie en
solaire thermique permettant de valoriser soit en chaleur, soit en électricité, l’énergie
solaire. Suit une évaluation de l’évolution du solaire thermique à différentes échelles
est présentée. Finalement, les différents travaux de la littérature dans le domaine du
solaire thermique et plus particulièrement pour les \abr{SSC}s sont discutés. Ces avancées
sont utilisées afin de pouvoir proposer un \abr{SSC} et une méthodologie adaptée à la
conception de \abr{MEPOS}s dont le détail de la démarche est discuté dans la dernière
partie de ce chapitre.
% section objectifs_et_importance_du_contexte_international (end)
...
raisonné. La dernière partie discute plus en détail les actions françaises et sa
...
Lorsque seules les émissions naturelles sont considérées, les résultats de simulations
...
Le contexte général étant introduit la section qui suit s’intéresse au développement
aux mesures telles que les labels ou le cadre réglementaire, et plus particulièrement
à la définition du concept de \abr{BEPOS}.
...
Afin de pouvoir proposer une méthodologie adaptée, il est nécessaire dans un premier temps
de comprendre comment le cadre réglementaire a évolué. Dans un second temps, il est
nécessaire de mieux appréhender la notion de \abr{BEPOS} simple dans le contexte mais dont
la mise en place est complexe. En effet afin de répondre de manière efficace aux problèmes
de réchauffement climatique et de sur-population les différents acteurs internationaux
doivent s’accorder sur une base de définition commune ensuite adaptée au niveau européen
puis national pour répondre aux contraintes propres de chaque nation. Le cadre européen
(\abr{PREN\,$15603$}) est particulièrement important pour ces travaux car sa définition
aura un impact direct sur la définition de la réglementation nationale.
Il apparaît de plus que le solaire a un rôle important à jouer dans le respect de
l’ensemble des contraintes qu’elle impose. En effet en plus d’imposée une enveloppe
performante, un consommation réduite, et un bilan annuelle positif, une part importante
des consommations doivent être couvertes par des énergies renouvelables produites
localement. Le solaire thermique est donc particulièrement adapté pour répondre à
cette nouvelle contrainte et les \abr{SSC} une solution potentielle.

Cette section introduit donc le concept général illustrée à travers les actions françaises
puis le cadre international et finalement européen sont discutés.
% ------------------------------------------------------------------------------
...
pour la rénovation. C’est dans cette optique que le concept de \abr{BEPOS} a été
développé.
...
\label{ssub:bilan_initiative_fr}
Bien que non décrit dans ces travaux, il est aussi possible de faire labelliser un bâtiment
...
pour appliquer au niveau national les nouvelles directives. Il reste cependant nécessaire
de définir un cadre international commun.
...
disponibles~: émissions de \abr{GES}, énergie grise, déchets radioactifs
...
Un \textit{Net}\,\abr{ZEB} est par définition connecté au réseau. De plus il a été mis en évidence
...
énergétique en période hivernale. La difficulté réside ainsi dans la gestion des pointes
de consommations (hiver), des excédents de production (été), et de la non-continuité
...
proposée par \textcite{Salom2011} puis intégrée dans les travaux de annexe $52$
\parencite{Salom2014}.
...
rédaction d’un cadre normatif~: \abr{PREN\,$15603$} \parencite{CEN2013}. Ces travaux
s’inscrivent dans un projet de normalisation européenne pour le développement d’une
définition commune, flexible, et claire de la \textit{nearly}\,\abr{ZEB} afin d’inciter
...
usages pris en compte, la période et les limites physiques considérées, le type de bilan, et
...
permettent d’identifier forces et faiblesses de chaque approche.
...
Il est aussi mis en évidence que afin de respecter les nouvelles contraintes imposées par
la norme européenne, une source locale d’énergie est nécessaire. De plus il est mis en
avant que la production locale sera évaluée en excluant l’énergie exportée vers le réseau
et que chaque vecteur énergétique sera évalué séparément. Ainsi la production locale
revendu au réseau par exemple par l’intermédiaire des capteurs \abr{PV} ne sera pas
comptabilisé. De la même manière, un bâtiment les consommations en énergie fossile, comme
par exemple une chaudière au gaz, ne pourront pas être compensés par une production
\abr{PV}. Le résultat reste le même si le choix a été fait d’une installation en
auto-consommation car les deux vecteurs énergétiques diffèrent. Ainsi le solaire thermique et
par extension les \abr{SSC} apparaissent comme une solution pertinente pour répondre à la
fois au problème de réchauffement climatique et aider au respect des nouvelles
contraintes réglementaires. Bien que les \abr{SSC} soient en théorie une solution pertinente, il reste
cependant nécessaire d’évaluer le potentiel d’économie énergétique qu’il peut apporter à
travers l’évaluation d’un \abr{SSC} adaptée aux \abr{MEPOS}. C’est dans cette optique
qu’il est proposé à travers ces travaux une méthodologie pour aider à la conception de
\abr{MEPOS} solaire et permettre de caractériser leur potentiel.
...
Il a été mis en exergue que le solaire et plus particulièrement le solaire thermique
est une solution pertinente pour réduire les consommations d’une \abr{MEPOS} et
permettre d’assurer qu’une part importante locale soit assurée par des énergies
renouvelables. L’avantage principal d’un système solaire thermique actif, est sa simplicité.
Il est en effet uniquement nécessaire d’avoir un capteur solaire, une pompe et un
ballon. C’est pour cette raison que ces systèmes sont utilisés depuis longtemps avec
plus ou moins d’efficacité. Bien que relativement simple à mettre en place en comparaison
avec les autres alternatives telles que le photovoltaïque, les \abr{SSC} ne sont
pas populaires. Le défaut principal de ces systèmes et en effet la place que prennent
les équipements et le coût d’investissement nécessaire. Ces deux critères sont liés,
un système nécessitant un nombre important de capteurs ou un volume de ballon
plus important coutera plus cher et prendre plus de place. Ces deux facteurs représentent
les principaux verrous qui freinent le développement de la technologie. Il est donc
nécessaire de simplifier et surtout réduire le volume nécessaire tout en conservant
un système solaire performant et représente un des objectifs de ces travaux.

Cependant avant d’introduire le \abr{SSC} retenue et pourquoi il a été retenu, il apparaît
important comme pour le \abr{BEPOS} de présenter le contexte général et les différents
travaux existants. En effet ce sont ces travaux qui ont permis le développement du
\abr{SSC} utilisé dans ces travaux afin de caractériser le potentiel du couplage entre une
\abr{MEPOS} et un \abr{SSC}. Ainsi cette section présente dans un premier temps l’énergie
...
réalisées sur les \abr{SSC} est discuté à travers un état de l’art.
...
fragments de mois qui forment une année caractéristique du climat du site étudié. Ces fichiers
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=0.8\textwidth]{Ressources/Images/Solaire/pyrheliometre.png}
        \caption{}
        \label{fig:schema_pyrheliometre}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=0.8\textwidth]{Ressources/Images/Solaire/pyranometre.jpg}
        \caption{}
...
utilisée. Dans ce cas de figure, il est important de correctement estimer le l’irradiation
solaire en période estivale qui aura un impact direct sur le potentiel du \abr{SSC}.
...
\begin{figure}
    ...
    \caption[Comparaisons mensuelles de l’irradiation solaire entre un fichier typique et des données réelles]
            ...
            et le fichier typique de Bordeaux.}
...
\paragraph{} % (fold)
La seconde approche permet de limiter la durée de simulation en utilisation des
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Ressources/Images/Solaire/tmy_generation.png}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth, clip=true, trim=0mm 150mm 195mm 0mm]{Ressources/Images/Solaire/ear_ray.pdf}
        \caption{}
        \label{fig:ear_ray}
    \end{subfigure}
    \quad
...
L’énergie solaire est utilisée depuis très longtemps afin de fournir soit de
l’électricité, soit de l’énergie sous forme de chaleur.
Le système le plus courant dans le domaine du bâtiment pour récupérer cette énergie,
...
la géométrie. Ces corrélations sont utilisées dans ces travaux afin de
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=0.85\textwidth]{Ressources/Images/Solaire/capteur_plan.jpg}
        \caption{}
        \label{fig:capteur_plan}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=0.9\textwidth]{Ressources/Images/Solaire/capteur_plan_vitre.jpg}
        \caption{}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.35\textwidth}
        \includegraphics[width=0.8\textwidth]{Ressources/Images/Solaire/caloduc.jpg}
        \caption{}
        \label{fig:capteur_sous_vide}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.55\textwidth}
        \includegraphics[width=0.9\textwidth]{Ressources/Images/Solaire/cylindro_parabolique.jpg}
        \caption{}
...
coefficients varient, l’écart étant fonction de la différence de surface entre l’absorbeur
et la surface d’entrée. De plus certains organismes de certification fournissent aussi la
valeur de ces coefficients suivant la surface totale du capteur. Il est donc nécessaire de
bien faire la distinction entre surface totale, d’entrée, et d’absorbeur.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Ressources/Images/Solaire/static_vs_quasi.png}
...
des initiatives actuellement en cours afin d’encourager le développement des
\abr{SSC}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Ressources/Images/Environnement/evolution_enr.png}
...
de construire des \abr{BEPOS} et les \abr{SSC} peuvent permettre d’atteindre ces nouveaux
objectifs propre à la production locale.
Les \abr{SSC} restent donc une solution du futur mais leur dimensionnement doit adaptée
...
\begin{subequations}\label{eq:indicateur_performance}
    \begin{align}
        F_{sav, therm} &= 1 - \frac{Conso_{complément}}{Conso_{ref}}                        \\[10pt]
        F_{sav, ext}   &= 1 - \frac{Conso_{complément} + Conso_{aux}}{Conso_{ref} + Conso_{aux, ref}}  \\[10pt]
...
Dans la sous-tâche B, un nouveau modèle de capteur solaire détaillé est ajouté à \textit{TRNSYS},
(type~$132$). Le rendement du capteur est défini à partir des équations quasi-dynamiques
explicitées à travers \ref{ssub:rendement_d_un_capteur_solaire_thermique}.
...
température minimale pour le chauffage et l’ECS, climat, qualité de l’enveloppe
\dots\ Chaque système est modélisé dans \textit{TRNSYS} et est évalué par
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Ressources/Images/Solaire/compare_systems.png}
...
composant le \abr{SSC} sont retenue comme critères de décisions. L’optimisation
...
frais de protection, ainsi que du coût lié à l’environnement. L’évaluation économique d’une
...
Le contexte et les contraintes spécifiques propre au sujet de ces travaux ont ainsi
pu être identifiés~:
\begin{itemize}
  \item Les énergies renouvelables et donc l’énergie solaire se place comme une
        alternative pertinente pour lutter contre le réchauffement climatique.
  \item Le développement du solaire thermique stagne en Europe et celui des \abr{SSC}
        est très peu développé.
  \item Il est nécessaire de repenser la conception des \abr{SSC} pour les revaloriser
        dans le cadre des \abr{MEPOS}, d’adapter les systèmes aux nouvelles contraintes
        du bâtiment.
  ...
  \item Les \abr{SSC} doivent donc être évalués suivant un bilan exportation / importation
  ...
  \item Afin d’évaluer le potentiel solaire, le modèle doit être détaillée afin
        de permettre l’implémentation d’une logique de contrôle adaptée.
\end{itemize}
% subsubsection bilan (end)
...
\itodo{Introduire la dernière section}
...
d’itérations successives. Ce processus est coûteux en temps humain et ne permet pas de valoriser la
puissance de calcul disponible qui offre pourtant la possibilité
d’explorer un nombre important de solutions et de vérifier des suppositions plus
rapidement. De plus, les réalités économiques et la forte concurrence
...
mécaniques. Par extension la construction d’une maison à énergie positive (\abr{MEPOS})
solaire est donc aussi multi-objectifs.
...
\abr{MEPOS} dont chaque pays membres devra s’inspirer pour la définition de leur nouvelle
...
une part importante de la consommation des \abr{MEPOS}.
