...
(\figref{fig:tendances_enr}). Depuis $2010$ la tendance est toujours à la baisse (progression plus
...
\itodo{Exergie}
L’exergie permet de quantifier la qualité d’une énergie, celle ci diminuant au cours des transformations
successives. La valeur minimisée dans les travaux est donc la somme de l’exergie détruite
