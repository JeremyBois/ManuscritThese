...
\begin{tabular}{l *{6}{C{2.2cm}} *{5}{G} G}
    \toprule
            & Type de Chaudière    & Appoint électrique  & \abr{CH} mixte  & \abr{CH} et \abr{ECS} simultanés & Type $Prod_{CH}$ & Type $Prod_{ECS}$ & Débit  variable & Contrôleur unique \abr{CH} et \abr{ECS} & $Ech_{sol}$ externe & Nombre d’échangeurs solaires & Nombre de ballons & Référence \\
    ...
    % \#9b    & Gaz / fioul          & Oui                 & -               & Oui                              & Indirecte        & Directe (ballon immergé)  & Non   & Oui (sauf \abr{ECS})  & - & 0 (circulation directe)   & 3 & \cite{Peter2003}  \\
    ...
    % \#15    & Gaz (unité compacte) & Non                 & -               & Oui                              & Indirecte        & Indirecte (échangeur à plaque)    & Oui (capteurs et \abr{CH})    &   & Non   & 2 + tube stratifiés   & 1 & \cite{Jaehnig2002}    \\
    % \#19    & Gaz / fioul          & Non                 & Oui             & Non                              & Indirecte        & Indirecte (échangeur à plaque)    & Non   & Oui   & Oui   & 2 + tube stratifiés   & 2 & \cite{Heimrath2003}   \\
    \midrule
    \bottomrule
\end{tabular}
\\[10pt]
