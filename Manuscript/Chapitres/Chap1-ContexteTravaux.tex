...
individus face aux ressources. Le terme \enquote{Développement durable}, aujourd’hui
largement repris, est introduit~:
...
Convention-cadre des Nations Unies sur les changements climatiques (CCNUCC) est adoptée et
est aujourd’hui ratifiée par $197$ pays montrant l’importance des question du
développement durable sur le plan international. Cette convention développe un plan
d’action pour le $21ème$ siècle connu sous le nom d’Agenda $21$ mais aussi $27$ principes
pour sa mise en œuvre. Les domaines traités sont très variés et couvrent par exemple la
pauvreté, la gestion des ressources notamment en eau, des déchets, mais aussi la pollution
ou l’agriculture\dots La $3ème$ Conférence des Parties (\abr{COP}, Conference Of Parties)
à Kyoto ($1997$) entrée en vigueur début $2005$, complète la convention par un accord
visant à réduire les émissions de gaz à effet de serre (\abr{GES}).

\href{http://www.automatesintelligents.com/echanges/2006/nov/rapportstern.html}{Stern bilan}\\
Pour la première fois, en $2006$, le \textit{rapport Stern} \parencite{Stern2006} commandé
par le gouvernement britannique décrit sur le plan économique l’impact d’une inaction face
aux problèmes du réchauffement climatique. Précédemment porté par des scientifiques, la
sonnette d’alarme est ici tirée par un économiste mettant en avant les risques tant sur le
plan humain que économique. Le réchauffement impacte en effet directement les composantes
essentielles de notre mode de vie~: l’accès à la santé, à la nourriture, à l’eau\dots Il
est alors suggéré un effort de recherche et une coopération technique au niveau
international afin de répondre à la problématique de manière efficace. Il met aussi en
avant la nécessité pour les pays riches, principaux responsables du réchauffement
climatique, d’aider au développement des pays plus pauvres dans des conditions
respectueuses de l’environnement.


Au niveau européen, la réunion de mars $2007$ entre gouvernements et chefs d’états de
l’Union Européenne (\abr{EU}) définissent des objectifs globaux pour $2020$. Ces objectifs
sont au cœur de la directive $20/20/20$ (\mtodo{Ajouter ref}) et engage l’Europe à réduire
de \SI{20}{\percent} (par rapport à $1990$) ces émissions de Gaz à Effet de Serre
(\abr{GES}), à améliorer de \SI{20}{\percent} l’efficacité énergétique, et à couvrir
\SI{20}{\percent} de la consommation finale par des énergies renouvelables. En France,
l’engagement \enquote{facteur 4} ($2003$) et la directive européenne sont repris dans les
objectifs des lois \textite{Grenelle I et II} \parencite{Grenelle2010}. Ce texte traduit
pour la France une volonté de décisions sur le long terme à la fois sur le plan sociétal,
politique, et économique, même si la question du nucléaire n’est pas encore à l’ordre du
jour. Ces lois marquent le premier pas vers une démarche responsable sur les transport, la
santé, l’énergie ou encore la préservation de la bio-diversité comme notamment avec la
labellisation de l’agriculture BIO ou la réduction de la précarité énergétiques des
foyers.
...
que sur les émissions de \abr{GES} afin de préparer à la sortie des énergies fossiles
et créer de l’emploi pour une population en augmentation. Il y est notamment inscrit
l’objectif d’une réduction de 40\% de l’émission de \abr{GES} entre 1990 et 2030 et la
...
de mesures pour la réduction des émissions (\abr{GES}) avec notamment l’objectif
de contenir le réchauffement climatique en dessous des 2°C (réalisation du plan facteur 4) et ainsi permettre
d’atteindre la \enquote{neutralité carbone} en compensant les \abr{GES} dans la seconde moitié
...
est complété par le scénario \abr{Afterres2050} développé par l’\abr{ONG} Solagro. Celui-ci s’inspire
...
(visible, proche \abr{UV} et \abr{IR}), un grande partie arrive à la surface de la terre. Une
