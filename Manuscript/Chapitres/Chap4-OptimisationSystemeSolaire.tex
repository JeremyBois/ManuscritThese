...
% ------------------------------------------------------------------------------
\subsection{Scénarios retenues} % (fold)
...
% subsection scenarios_retenues (end)
...
systèmes (\tabref{tab:facteur_sensibilite}).
...
\SI{\approx 7}{\metre\squared}. De plus la surface minimale de $PV$ a été définie afin de couvrir \mtodo{Ajouter
production}{\SI{0}{\kWh} sur les \SI{0}{\kWh}} nécessaires pour couvrir les consommations
...
% subsubsection production_d_électricite (end)
