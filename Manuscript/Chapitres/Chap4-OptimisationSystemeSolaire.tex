...
de contrôle et sont corrélés à la taille des ballons (\mtodo{Ref fig}). Lorsque le volume
des ballons est important,
...
Pour obtenir
la meilleure performance sur le chauffage et sur la production d’\abr{ECS}, il est
nécessaire de considérer un $\Delta T_{sol}$ faible (\SIrange{0}{10}{\celsius}).
Lorsque la taille des ballons est limitée (\SI{\geq 200}{\l}) une description plus précise
est possible. Obtenir la meilleure performance sur le chauffage nécessite un $\Delta T_{sol}$
...
et la performance du \abr{SSC}. Dans cette optique, $3$ indicateurs sont introduits, $p$,
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Exploration des solutions pour le climat de Strasbourg} % (fold)
\label{ssub:exploration_des_solutions_pour_le_climat_de_strasbourg}
...
de manière active aux choix constructifs, ou aux choix des systèmes sans avoir besoin
d’une expertise importante. Le client devient acteur de son choix et évalue mieux
les contraintes et atouts de chaque proposition. De la même manière, ce processus est
adaptée dans le cas où le respect d’une réglementation spécifique est nécessaire\dots

La large variété de solutions peut être observée à travers \mtodo{ref fig}.
Prenons le cas où le client souhaite limité au maximum la place prise par les équipements.
...
aussi limité le nombre de capteurs solaires thermiques sans augmenter le nombre
...
\begin{blockdescription}{Solution 1 (\abr{S1})~:}
  ...
  \item[Solution 6 (\abr{S6})~:] Cette solution maximise le $F_{sav,\,ext}$ mais
                                 ...
                                 différentes.
  \item[Solution 6 (\abr{S6})~:] Représente la solution qui maximise le $F_{sav,\,ext}$
...
\begin{tabular}{l c c c c c c c}
  ...
  \midrule
  Nombre capteurs \abr{TH}      & \num{7} & \num{7} & \num{7} & \num{2} & \num{7} & \num{7} & \num{5} \\
  Type capteurs \abr{TH}        & \multicolumn{5}{c}{\textit{SkyPro}}  & \textit{IDMK} & \textit{SkyPro} \\
  $Ech_{sol}^{pos}$             & \num{0.8} & \num{0.96}  & \num{1.23}  & \num{0.95}  & \num{0.94}  & \num{0.87}  & \num{1} \\
  Volume ballon tampon          & \num{400} & \num{100} & \num{400} & \num{250} & \num{200} & \num{400} & \num{400} \\
  Volume ballon $ECS$           & \num{400} & \num{400} & \num{200} & \num{350} & \num{200} & \num{400} & \num{400} \\
  $\Delta T_{sol}$              & \num{5} & \num{10}  & \num{8} & \num{10}  & \num{10}  & \num{18}  & \num{0} \\
  ...
  Surface vitrée sud    & \num{5.8} & \num{6.6} & \num{6,2} & \num{5.4} & \num{6.2} & \num{5.4} & \num{5.8} \\
  Surface vitrée est    & \num{4.3} & \num{4.7} & \num{4,3} & \num{4.7} & \num{4.4} & \num{4.6} & \num{4.3} \\
  Type de vitrage       & \multicolumn{3}{c}{\textit{PlanithermXN}} & \textit{PlanithermOne}  & \multicolumn{3}{c}{\textit{PlanithermXN}} \\
  \\
  \addlinespace[\defaultaddspace]
  \multicolumn{5}{l}{\textbf{Production d’électricité}}      \\
  \midrule
