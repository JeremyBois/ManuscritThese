...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \ftodo{Ajouter évolution hypervolume et Schott abandons pour optimisation Bordeaux}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \ftodo{Ajouter évolution hypervolume et Schott abandons pour optimisation Strasbourg}
...
% ------------------------------------------------------------------------------
\subsection{Variation du nombre de capteurs \abr{PV}} % (fold)
\label{sub:variation_du_nombre_de_capteurs_pv}
...
\end{figure}
% subsection variation_du_nombre_de_capteurs_pv (end)
...
\itodo{Variation algo en fonction objectif à maximiser}
