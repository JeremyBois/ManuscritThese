...
la production des capteurs \abr{PV} est discrète. La même remarques est faite pour
...
Ainsi l’algorithme réalise au minimum \num{36000} évaluations ($90 * IT$) mais est
...
d’\abr{ECS}, il est aussi obtenu de nombreux compromis sur les critères de décisions.
Les bornes du front de Pareto sont décrites dans \tabref{tab:bornes_front_pareto}.
