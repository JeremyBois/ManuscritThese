...
\itodo{Influence isolation (Strasbourg actuellement)}
...
% section optimisation_multi_objectif (end)
...
\ftodo{Variation performance entre mini volume et optimisation libre}
