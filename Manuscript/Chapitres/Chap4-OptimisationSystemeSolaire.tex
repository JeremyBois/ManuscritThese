...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Bilan énergétique passif} % (fold)
...
% subsubsection bilan_énergétique_passif (end)
...
valide, une étude paramétrique a été menée (\figref{fig:meta_taille_echantillon}).
...
\itodo{Décrire résultats}


\begin{figure}
    \centering
    \itodo{Ajouter variation MAE et RMSE en fonction de la taille de l’échantillon + Ordre méta}
    % \includegraphics{Ressources/Images/Sensibilite/sigma_mu_star_objectifs.pdf}
    \caption{Résultat de l’analyse de Morris pour les objectifs principaux
             ($f(\mu^{*}) = \sigma$).}
