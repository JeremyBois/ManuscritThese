...
permet de réduire de $8$ (\SI{13.1}{m^{2}}) le nombre de capteurs \abr{PV} nécessaires
(\figref{fig:fsav_pv_stras}). Sur Bordeaux ajouter $3$ (\SI{7.0}{m^{2}}) capteurs
thermique permet de réduire de $5$ (\SI{8.2}{m^{2}}) le nombre de capteurs \abr{PV}
