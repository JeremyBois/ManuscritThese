...
sans limiter le nombre de solutions par hypercubes se révélant alors très élitiste. Ici,
...
En cas de solutions multiples (pour un même hypercube), la dominance selon Pareto est appliquée pour
sélectionner la solution qui sera conservée. Cette approche permet de garantir une
diversité sur l’ensemble de l’espace de décision pour un temps de calcul très faible.
\ftodo{Ajouter la description de l’algorithme (voir (Deb2005501)}
