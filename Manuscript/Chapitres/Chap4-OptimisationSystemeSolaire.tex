...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth, clip=true, trim=0mm 20mm 0mm 0mm]{Ressources/Images/EtudeDeCas/AideDecision/base.png}
    \\
    \includegraphics[width=0.95\textwidth, clip=true, trim=0mm 20mm 0mm 0mm]{Ressources/Images/EtudeDeCas/AideDecision/volume_ballons.png}
    \\
    \includegraphics[width=0.95\textwidth, clip=true, trim=0mm 20mm 0mm 0mm]{Ressources/Images/EtudeDeCas/AideDecision/final.png}
