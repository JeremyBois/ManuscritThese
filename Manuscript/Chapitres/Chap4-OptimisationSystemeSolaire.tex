...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Application de la méthode pour le \abr{SSC} sur Strasbourg} % (fold)
\label{ssub:application_de_la_méthode_pour_le_ssc_sur_strasbourg}
\itodo{Critères d’aide à la décision}
...
\itodo{coût, Suface disponible, fournisseurs locaux, type de clientèle, réglementation, ...}

\itodo{Application}
% subsubsection application_de_la_méthode_pour_le_ssc_sur_strasbourg (end)
