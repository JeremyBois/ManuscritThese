...
\itodo{Ajouter captures du modèle (algo FSM et global)}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.5\textwidth]{Ressources/Images/Modelisation/exemple.PNG}
...
du modèle retenu est discuté. Ensuite, le \abr{SSC} et détaillé et les divers équipements
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Ressources/Images/Modelisation/Capteurs/IDMK/IAM.pdf}
...
par les données expérimentales (\figref{fig:compare_capteurs}, gauche). De plus, les les
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Ressources/Images/Modelisation/compare_capteurs.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Ressources/Images/Modelisation/Regulation/chauffage_fsm.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Ressources/Images/Modelisation/Regulation/chauffage_aeraulique.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{Ressources/Images/Modelisation/Regulation/control_air_curve.pdf}
