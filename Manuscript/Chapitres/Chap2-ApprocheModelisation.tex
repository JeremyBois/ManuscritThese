...
\begin{itemize}
    ...
    \item Le "refactoring" permettant de renommer de manière dynamique une variable
...
(\mtodo{Ajouter ref tab}). Il est considéré pour l’ensemble des vitrages, une composition
...
comparer avec les données fabricants, les conditions limites des directives européennes
\href{http://tinyurl.com/l8vkdnb}{EN\,673-2011} et \href{http://tinyurl.com/n2s3zun}{EN\,410-2011}
...
\iunsure{Ajouter comparaison entre calcul selon diverses normes}

\begin{table}
\centering
\caption{Détail du calcul du $U_{g}$ et du $g$ selon \href{http://tinyurl.com/l8vkdnb}{EN\,673-2011}
         et \href{http://tinyurl.com/n2s3zun}{EN\,410-2011}.}
...
\itodo{Ajouter réduit diurne}
% subsubsection ventilation (end)
% subsection scénarios_de_référence (end)

\begin{figure}
    \begin{center}
        \ftodo{Ajouter figure des profil de charges internes et occupation}
        % \includegraphi\ftodo{Profil d’occupation retenue}cs{Ressources/Images/Modelisation/maison.png}
    \end{center}
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Partie hyraulique} % (fold)
...
Enfin, le système comporte 3 pompes~: S6, S5, et S2. Il est considéré un débit nominale de
...
variable afin de limiter les arrêts intempestifs des pompes \parencite{Kicsiny20123489}.
...
empiriques décrites dans le volet 2 de la norme \mtodo{Ajouter lien}{EN\,12975}.
...
avec les résultats du modèle (\mtodo{Ajouter type} implémenté dans \emph{TrnSys}. Les deux
...
modèles hydrauliques de la bibliothèque \emph{Buildings} considère un cas idéal
...
($NZEB$, \munsure{Nearly or Net}{Nearly Zero Energy House}).
