...
multi-zone sont similaires~: respectivement \SI{1114}{\kilo\watt\hour} et
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\itodo{Décrire le modèle specifique retenu pour chaque équipement}
\itodo{régression linéaire IAM pour le capteur}
...
limiter les arrêts intempestifs \parencite{Kicsiny20123489} et favoriser des débits
réduit comme le recommande la littérature. Ainsi sur la période de chauffage le débit
moyen est de \mtodo{Ajouter moyenne} pour un écart type de \mtodo{Ajouter écart type}.
...
\begin{table}
\centering
\itodo{Ajouter Delta et Tmini ECS}
