...
\SI{1190}{\kilo\watt\hour} pour une année complète (\figref{fig:compare_models}).
...
Afin de tenir compte de la variation de la température dans les capteurs, ceux-ci sont discrétisés
en \num{20} sous-volumes.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=0.55\textwidth]{Ressources/Images/Modelisation/Regulation/hysteresis.pdf}
        \caption{}
    ...
    \begin{subfigure}[b]{0.6\textwidth}
        \centering
        \includegraphics[width=0.55\textwidth]{Ressources/Images/Modelisation/onOff_control.pdf}
        \caption{}
        \label{fig:onOff}
    \end{subfigure}
...
Chaque équipement ou entité est dans ces travaux représenté comme un automate fini (noté \abr{FSM},
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Ressources/Images/Modelisation/Regulation/exemple_fsm.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Ressources/Images/Modelisation/Regulation/chauffage_fsm.pdf}
...
des travaux de la littérature afin de proposer une approche simple et robuste en considérant
le bâtiment et les systèmes comme un ensemble (\figref{fig:fonctionnementSystemeRecap}).
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\textwidth, clip=true, trim=50mm 0mm 10mm 0mm]{Ressources/Images/Modelisation/sankey_diagram.pdf}
    \caption[Récapitulatif du fonctionnement couplé du système solaire combiné et du bâtiment.]
            {Récapitulatif du fonctionnement couplé du système solaire combiné et du bâtiment.}
    \label{fig:fonctionnementSystemeRecap}
\end{figure}
...
\begin{table}
\centering
\caption[Température de l'eau du réseau en fonction de la position géographique]
        {Température de l'eau du réseau (\si{\celsius}) au cours
...
$Conso_{app}$  (\abr{ECS} + \abr{CH}) est très faible.

La $Conso_{app}^{ECS}$ pour les conditions de Limoges et de Nantes sont similaires malgré
une consommation totale pour la production d’\abr{ECS} plus importante sur Limoges. L’ensoleillement
plus élevé sur la ville de Limoges (\tabref{tab:description_climat}) permet en effet de
valoriser une part d’énergie solaire plus grande. Pour les mêmes raisons, le \abr{SSC}
