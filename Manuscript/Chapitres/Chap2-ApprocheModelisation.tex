...
Le processus de développement du modèle étant itératif, l’outil sélectionné
...
\itodo{Ajouter comparatif des puissances}.
...
Afin de garantir le maintien du confort thermique des occupants, un appoint électrique en partie
...
\paragraph{Illustration du fonctionnement~:} % (fold)
...
% paragraph illustration_du_fonctionnement_ (end)
...
Strasbourg %(Fig~\ref{fig:puissance_annuelle_defavorable})
