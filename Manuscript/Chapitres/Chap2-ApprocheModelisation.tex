...
Le langage Modelica et le logiciel Dymola (Dynamics Modeling Laboratory) permettent de
répondre à l’ensemble des contraintes décrites dans la section précédente. Modelica est un
...
les systèmes d’équations afin d’isoler les inconnues. Le développement sous Modelica
permet ainsi de rapidement prototyper des systèmes complexes sans devoir à chaque
...
\label{par:dymola}
Dymola est une suite de logiciels développée par Dassault Systèmes permettant de
simplifier le développement de modèles numériques grâce au langage Modelica. Il offre une
...
transparent la modification du nom d’une variable. Il offre aussi un outil de post-
traitement afin d’évaluer les résultats des simulations. Finalement il intègre le logiciel
Dymosim qui offre un large choix de solveurs pour simuler les modèles. Dymosim supporte
aussi la parallélisation, les FMU (FunctionalMock-Up Unit) et la génération de modèles
autonomes.
