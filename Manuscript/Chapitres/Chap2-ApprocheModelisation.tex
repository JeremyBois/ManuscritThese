...
\begin{tabular}{ L{4cm} c | c  c  c  c  c  c }
  \toprule
                                      &    &    & \textbf{Bordeaux} & \textbf{Nantes} & \textbf{Strasbourg} & \textbf{Limoges} & \textbf{Marseille} \\
  \midrule
  \multirow{2}{4cm}{Température de l’eau du réseau} &
  \multirow{2}{*}{\si{\celsius}}  & Min    & \num{8.9}               & \num{8.3}               & \num{5.3}                 & 7                 & 12                \\
                                 & & Max    & 16                & 15               & 14                  & 14                & 19                \\
  \midrule
  DJU (\SI{19}{\celsius}) & \si{\celsius} & Totaux  & 2408              & 2660               & 3360                & 2972              & 2049              \\
  \midrule
  \multirow{3}{4cm}{Irradiation solaire} &
  \multirow{3}{*}{\si{kWh/m^{2}}} & Global & 1264              & 1184               & 1091                & 1257              & 1545              \\
                                  &    & Direct & 929               & 885               & 721                 & 1209              & 1503              \\
                                  &    & Diffus & 712               & 665               & 650                 & 602              & 615               \\
  \bottomrule
\end{tabular}
\end{table}
...
$DeltaT_{solaire}$, la différence de température entre la source (sortie des capteurs) et la cible (sortie des
échangeurs) est modulée autour du cas de référence (\SI{10}{\celsius}) avec deux nouvelles
variations~: \SI{5}{\celsius} et \SI{15}{\celsius}. Augmenter le $DeltaT_{solaire}$ revient à
...
temporisation de \SI{10}{min} et elle sera notée $Tempo_{soufflage}$.
...
\caption{Description de la solution de référence et de variations étudiées.}
  ...
  \begin{tabular}{l r c C{4cm} r}
    \toprule
    \rule{0pt}{15pt}                                 & Unité & Référence & Variations & Détails  \\[5pt]
    \midrule
    ...
    $Tempo_{soufflage}$              & \si{\min}     & 10        & 5, 15 &                                                       \\
    $DeltaT_{solaire}$               & \si{\celsius} & 10        & 5, 15 &                                                       \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}
\centering
\caption{Performances annuelles du système solaire pour différents climats. Le chauffage est décrit
         par l’abréviation $Chauff$.}
\label{tab:performance_annuelles}
\begin{tabular}{| l | c | c | c | c | c | c | c | c | c | c | c |}
    \toprule
             &   \multicolumn{9}{ c |}{\bf{Consommation (kWh)}} & \multicolumn{2}{ c |}{\bf{\%}} \\
    \midrule
     & \multicolumn{2}{ c |}{\bf{Total}}   &  \multicolumn{3}{ c |}{\bf{Électrique}}  & \multicolumn{6}{ c |}{\bf{Solaire}}                                               \\
    \midrule
               & $ECS$    & $Chauff$    &  $ECS$        & $Chauff$ & \bf{Pompes}      & $Solaire_{récupérée}$ & $Pertes_{canalisations}$ & $ECS$  & $Chauff$ & $F_{ECS}$  & $F_{Chauff}$ \\
    \midrule
