...
% ------------------------------------------------------------------------------
\subsection{Composition du système solaire} % (fold)
...
~
\itodo{Ajouter origine des caractéristiques des capteurs et raisons}
\itodo{Ajouter capteurs envisagés}
...
% subsection composition_du_système_solaire (end)
