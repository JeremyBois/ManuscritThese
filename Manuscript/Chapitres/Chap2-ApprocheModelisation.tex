...
\itodo{Mieux utilisé la figure pour expliquer FSM}
...
\itodo{Ajouter Delta et Tmini ECS et expliquer la variation}
...
appoints (chauffage et $ECS$) mais aussi de la consommation des pompes du \abr{SSC}. Elle est
...
équipements et des occupants pour analyser la performance d’un \abr{SSC} pour des maisons
...
\itodo{Décrire impact nouvelles variations algo}
