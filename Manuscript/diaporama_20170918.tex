...
\begin{frame}[c]
    \vfill
     ~: Approche actuelle dans le bâtiment par essais/erreurs
     ...
     \begin{columns}
        \begin{column}{0.45\textwidth}
            ...
            \begin{itemize}
                \item Intuitif
                \item Essais / erreurs
                \item Expérience uniquement
                \item Amélioration solution de base
            \end{itemize}
        \end{column}%
        \begin{column}{0.55\textwidth}
            \centering
            ...
            \begin{itemize}
                \item
                \item Automatisée
                \item Valorisation de la puissance machine
                \item Exploration du domaine de décision
                \item Renforcement de la connaissance
            \end{itemize}
            }
        \end{column}%
    \end{columns}%
