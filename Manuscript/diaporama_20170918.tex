...
%                 \begin{flushleft}
%                     \includegraphics[scale=0.07]{Ressources/Templates/Soutenance/Include/logos/I2M_logo.jpg}
%                 \end{flushleft}
%             \end{column}%
%             \begin{column}{0.3\textwidth}
%                 \begin{center}
...
%             \begin{column}{0.3\textwidth}
%                 \begin{flushright}
%                     \includegraphics[scale=0.08]{Ressources/Templates/Soutenance/Include/logos/bordeaux_logo.jpg}
%                 \end{flushright}
%             \end{column}
%         \end{columns}
%         \vspace{1cm}
...
%         \begin{column}{0.3\textwidth}
%             \begin{flushleft}
%                 \includegraphics[scale=0.05]{Ressources/Templates/Soutenance/Include/logos/cea_logo.png}
%             \end{flushleft}
%         \end{column}
%         \begin{column}{0.3\textwidth}
%             \begin{center}
%                 \includegraphics[scale=0.22]{Ressources/Templates/Soutenance/Include/logos/comepos_logo.png}
%             \end{center}
%         \end{column}
%         \begin{column}{0.3\textwidth}
%             \begin{flushright}
%                 \includegraphics[scale=0.13]{Ressources/Templates/Soutenance/Include/logos/aquitaine_logo.png}
%             \end{flushright}
%         \end{column}
%         \end{columns}
%     }
...
%     \begin{columns}
%         \begin{column}{0.3\textwidth}
%             \includegraphics[height=8mm]{Ressources/Templates/Soutenance/Include/logos/modelica_logo.png}
%         \end{column}
%         \begin{column}{0.3\textwidth}
%             \includegraphics[height=8mm]{Ressources/Templates/Soutenance/Include/logos/dassault_logo.jpg}
%         \end{column}
%         \begin{column}{0.3\textwidth}
%             \includegraphics[height=8mm]{Ressources/Templates/Soutenance/Include/logos/dymola_logo.jpg}
%         \end{column}
%     \end{columns}
%     \vfill
%     ~
